...
#Therefore, if you simply split the train into disjoint partitions, 
#the underlying time intervals may overlap. 
...
# linear model target variable of V281 
model1<-lm(train$V281~., data = train)
model1
summary(model1)
...
median is -0.127
R square is 0.4737
Adjusted R square is 0.471, which is 47.% variables are not correlated 
